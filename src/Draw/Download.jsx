...
export let keydownfx = (e, context, target) => {
  ...
  if (e.key== "G" ||e.key == "g") {
    ...
    if (Object.keys(targetObject.current).length>0) {
          console.log(
            Object.keys(targetObject.current).length,
          ...
          let attrdata=''
                ...
                element.setAttribute("d", attrdata);
                console.log(attrdata);
          }
                    vgkey.current = vgkey.current.filter(
                      (e, i) =>
                        i !== target || i == Object.keys(targetObject.current)[0]
                    );
  ...
  if (e.key === "e" || e.key === "E") {
    ...
    Object.keys(obj).map((e) => {
      ...
      targetObject.current[Array.from(vg.current.children).indexOf(el)] = tgt;
    });
